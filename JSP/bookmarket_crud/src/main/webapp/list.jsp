	...
	<div class="row align-items-md-stretch   text-center">	 	
		<form action="BoardListAction" method="post">
			...
			<div class="py-3" align="right">							
				<a href="#" onclick="checkForm(); return false;" class="btn btn-primary">&laquo;글쓰기:js</a> <!-- return false a태그 href 실행 취소 -->		
				<a href="BoardWriteForm"  class="btn btn-primary">&laquo;글쓰기:java</a>
			</div>			
			<div align="left">				
