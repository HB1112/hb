...
@WebServlet("/7_1_one")
public class exam07_1_one extends HttpServlet{

	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse response) throws ServletException, IOException {
		
		RequestDispatcher ds = req.getRequestDispatcher("chapter07/exam7_01_fileupload01.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher ds = request.getRequestDispatcher("chapter07/exam7_01_fileupload01_process.jsp");
