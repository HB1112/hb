...
@WebServlet("/7_2")
public class exam07_02 extends HttpServlet{

	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		RequestDispatcher ds = req.getRequestDispatcher("chapter07/exam7_02.jsp");
		ds.forward(req, resp);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher ds = req.getRequestDispatcher("chapter07/exam7_02_process.jsp");
		ds.forward(req, resp);
	}
